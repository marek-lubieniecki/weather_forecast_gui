...
pressures = np.arange(10, 110, 10)
of_ratios = np.arange(1, 5.2, 0.2)
...
for pressure_id, pressure in enumerate(pressures):
   ax3.plot(of_ratios, liquid_engine.total_efficiency * specific_impulses[pressure_id, :], label = pressure)  # Matplotlib plo
